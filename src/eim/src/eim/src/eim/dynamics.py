...
def update_interaction_pressure(G, node_data, interaction_pressure, dt=0.05):
    new_pressure = {}
    for node in G.nodes():
        # Use seam asymmetry from projectors (will be imported)
...
def inject_gravitational_wave(G, center_node, strength=5.0, radius=3):
    """Localized scar spike + shockwave for GW event simulation"""
